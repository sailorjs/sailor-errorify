...
function WLError(properties) {
  ...
  // Default properties
  WLError.prototype.status  = typeof properties === 'object' && properties.status  || 500;
  WLError.prototype.code    = typeof properties === 'object' && properties.type    || 'E_UNKNOWN';
  WLError.prototype.reason  = typeof properties === 'object' && properties.summary || 'Encountered an unexpected error';
  WLError.prototype.details = typeof properties === 'object' && properties.details || '';

  // Call super constructor (Error)
  WLError.super_.call(this);

  // Fold defined properties into the new WLError instance.
  if(typeof properties === 'object' && properties.object){
    properties = {originalError: properties.object};
  } else {
 ...
 */
module.exports = {
  new_WLError: function(obj){
    return new WLError(obj);
  },
