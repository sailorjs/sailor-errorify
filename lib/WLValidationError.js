...
module.exports = function(obj){
  ...
  // SAILS GROUPS
  // var invalidAttributes = {invalidAttributes: {}, model: 'MyModel'};
  // invalidAttributes.invalidAttributes['firstName'] = [{
  //   rule: 'your_rule_name',
  //   message: 'your custom message'
  // }];
  // invalidAttributes.invalidAttributes['lastName'] = [{
  //   rule: 'your_other_rule_name',
  //   message: 'your other custom message'
  // }];

  // return new WLValidationError(invalidAttributes);

  // MY SOLUTION
  var invalidAttributes = {invalidAttributes: {}, model: obj.model};

  _.forEach(obj.attributes, function(attr){
    invalidAttributes.invalidAttributes[attr.name] = [{
      rule: attr.rule,
